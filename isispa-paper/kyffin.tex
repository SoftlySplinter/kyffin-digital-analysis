...
classified as the painting nearest to the statistical centroid.

In contrast, the artistic exemplar for 1960 - \emph{Nant Ffrancon from Llandegfan}
is commonly misclassified as \emph{Moelwyn Bach} and is never correctly classified as
the statistical exemplar.
...
\caption{Statistical Exemplar Error by Year for Gabor Filters (8 orientations)}
\end{figure}
