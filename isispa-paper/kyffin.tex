...
namely chi squared.
 ...
 basically all along we are generating histograms of feature response, 
 and then using these to classify. the histogram might just mean mean 
 R, G, B but it's a histogram all the same. 
