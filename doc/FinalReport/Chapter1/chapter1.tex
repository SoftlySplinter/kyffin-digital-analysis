...
show a Gaussian mixture model of Williams' work with the intention of being able to geographically
determine the location of a picture, especially those with a well defined setting especially those
painted at Crib Goch (figure~\ref{fig:crib-goch}, for example) 
...
This meeting was between Lloyd, Hannah and Lorna Hughes (Lloyd's PhD supervisor), again to discuss
...
Some other points were brought up with regards to Williams' work, such as the artistic cut-off 
