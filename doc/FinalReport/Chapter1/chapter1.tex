...
One of the simplest methods of classification is $k$-Nearest Neighbour. This takes an average of 
the years from the $k$ closest paintings in the data-set. This is assigned to be the year of the 
painting to classify.
...
There are other techniques which could be applied to this problem. The benefits for 
implementing them are not likely to be outweighed by the time taken to implement these
...
Another method of classification is to use expert knowledge, making use of the 
interdisciplinary work with members of the \gls{nlw}, to label dates of paintings.
This expert knowledge takes the form of a set of exemplar paintings
for each year in Williams' career. Therefore, allowing these exemplars to be compared to the
statistical centre of that year. This will allow the comparison of digital analysis to human experts.
